...
<?php include "includes/admin_navigation.php"?>
        ...
        <div id="page-wrapper">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <!-- Refactored code making it easier to query multiple tables using recordCount function $post_count = recordCount('posts');-->
                ...
                <div class="panel panel-green">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                            <!-- Refactored code making it easier to query multiple tables using recordCount function-->
            ...
            // Refactored code to using function checkStatus & checkUserRoles
...
<script>
    ...
    var pusher = new Pusher('0cde93b8887f4bcee7cb', {
      cluster: 'us2',
      forceTLS: true
    });
