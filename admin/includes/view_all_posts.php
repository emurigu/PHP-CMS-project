        ...
        switch($bulk_options){
            ...
            case'clone':
                ...
                while ($row = mysqli_fetch_array($select_post_query)) {
                    ...
                    if(empty([$post_image, $post_author])) {
                        $post_author = "No author yet";
                        $post_image = "No image yet";
                    }
                }
    ...
    <a href="posts.php?source=add_post" class="btn btn-primary">Add New</a>
        ...
        <tbody>
            <?php 
                ...
                // Joining DB Query to minimize server load
                $user = currentUser();
                ...
                $query .= " WHERE posts.post_author = '$user' ";//restricting posts displayed to only those created by current user.
