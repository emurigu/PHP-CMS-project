    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <?php
                ...
                if(isset($_GET['page'])) {
                    $page = $_GET['page'];//find correct escape string
                } else {
                    $page = "1";
                }
                ...
                if(isset($_SESSION['user_role']) && $_SESSION['user_role'] == 'admin') {
                    ...
                    $select_all_posts = mysqli_query($connection, $query);
                        ...
                        while($row = mysqli_fetch_assoc($select_all_posts)){
                            ...
                            <!--Post Image -->
                            <img class="img-responsive" src="/cms/images/<?php echo imgPlaceholder($post_image); ?>" alt="<?php echo $post_title; ?>"></a>
                            <hr>
                            <!--Button -->
